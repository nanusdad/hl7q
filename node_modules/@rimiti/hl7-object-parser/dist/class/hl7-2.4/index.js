    ...
    function hl7(message, config) {
        ...
        for (var j = 0; j < message.segments.length; j++) {
            if (message.segments[j].name == 'OBX') {
                message.segments[j].name = 'OBX' + obxindex[count];
                count++;
            }
        }
        count = 0;
...
//        for (var j = 0; j < message.segments.length; j++) {
//            if (message.segments[j]) {
//                if ((message.segments[j].name == 'OBX') && (message.segments[j + 1].name == 'OBX') && (message.segments[j + 2].name == 'OBX')) {
//                    message.segments[j].name = 'OBX1';
//                    message.segments[j + 1].name = 'OBX3';
//                    message.segments[j + 2].name = 'OBX4';
//                }
//            }
//        }
